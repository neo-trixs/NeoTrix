...
### l8_autonomic_impl/nt_mind/ — SEAL Loop Driver
...
The `Orchestrator` in `l8_autonomic_impl/nt_mind/` can use `MetaCycleResult` as input to its `PlannerNode`:
...
- Run in background (async, via `l8_autonomic_impl/nt_mind/`)
