...
| **Source file** | `l8_autonomic_impl/nt_mind/brain_impl.rs` → **新文件**: `element/capability_element.rs` |
...
|----------|-------|
| **ID** | `element.memory` |
| **Source file** | `l8_autonomic_impl/nt_mind/cortex_memory/` → **新文件**: `element/memory_element.rs` |
...
|----------|-------|
| **ID** | `element.skill` |
| **Source file** | `l8_autonomic_impl/nt_mind/` → **新文件**: `element/skill_element.rs` |
...
|----------|-------|
| **ID** | `element.goal` |
| **Source file** | `l8_autonomic_impl/nt_mind/goal_contract.rs` → **新文件**: `element/goal_element.rs` |
...
|----------|-------|
| **ID** | `element.thinking` |
| **Source file** | `l8_autonomic_impl/nt_mind/` → **新文件**: `element/thinking_element.rs` |
...
| **Source file** | `l8_autonomic_impl/nt_mind/evolution_module` → **新文件**: `element/evolution_element.rs` |
...
│
├── l8_autonomic_impl/nt_mind/         ← Restructured (was reasoning_brain/)
│   ├── ... (existing modules)
│
