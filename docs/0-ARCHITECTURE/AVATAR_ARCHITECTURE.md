...
| `l8_autonomic_impl/nt_mind/goal_contract.rs` | 分身拥有独立的 GoalContract 实例 |
| `l8_autonomic_impl/nt_mind/cortex_memory/` | 分身的 ReasoningBank 独立持久化 |
| `l8_autonomic_impl/nt_mind/core/capability.rs` | CapabilityVector 变异 + 增量序列化 |
