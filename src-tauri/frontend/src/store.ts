...
import type { Session, Message, ProviderConfig, PermissionRequest, KnowledgeEntry, AppSettings, AgentPreset, DesktopWindow, EvolutionState, EditorState, ProxyStatus } from "./types";
