...
describe("DiffViewer", () => {
  ...
  it("renders added lines with diff-added class", () => {
    ...
    expect(lines[0]).toHaveAttribute("data-diff-type", "added");
    expect(lines[1]).toHaveAttribute("data-diff-type", "removed");
    expect(lines[2]).toHaveAttribute("data-diff-type", "unchanged");
  });
