        ...
        None | Some(Commands::Desktop) => {
            ...
            builder
                ...
                .invoke_handler(tauri::generate_handler![
                    ...
                    commands::cmd_reorder_sessions,
                    commands::cmd_set_session_project,
                    commands::cmd_fork_session,
                    ...
                    commands::kb_geo_elevations,
                    commands::kb_geo_points_pack,
                    ...
                    commands::canvas_sync_capabilities, commands::canvas_prune_capability, commands::canvas_set_desired, commands::canvas_apply_evolution_route,
                    ...
                    commands::delete_api_key,
                     ...
                     commands::neocodex_provider_config,
                      ...
                      commands::neocodex_test_provider,
                      commands::neocodex_fetch_provider_models,
                      commands::neocodex_add_custom_provider,
                     ...
                     commands::neocodex_search_sessions,
                      ...
                      commands::neocodex_file_operation,
                       ...
                       commands::neocodex_git_commit,
                       commands::neocodex_git_push,
                       commands::neocodex_git_branch,
                       commands::neocodex_git_checkout,
                       commands::neocodex_git_staged_files,
...
commands::neocodex_set_project,
                    ...
                    // Computer background tasks (dead-code wiring)
                    commands::computer_bg_submit,
                    commands::computer_bg_list,
                    commands::computer_bg_get,
                    commands::computer_bg_cancel,
                    commands::computer_bg_retry,
                    commands::computer_bg_clear,
                    commands::computer_bg_stats,
                    commands::computer_bg_config,
                    commands::computer_bg_set_config,
                    commands::computer_bg_run_script,
...
commands::workflow_schedule_delete,
                     ...
                     // Workflow generation/export/duplicate/batch (dead-code wiring)
                     commands::workflow_generate,
                     commands::workflow_generate_suggest,
                     commands::workflow_export,
                     commands::workflow_duplicate,
                     commands::workflow_batch_run,
                     // Routines (dead-code wiring)
