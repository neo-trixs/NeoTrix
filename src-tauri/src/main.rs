...
commands::workflow_schedule_delete,
                     ...
                     commands::routines_get,
                     commands::routines_update,
                     commands::routines_delete,
                     commands::routines_enable,
                     commands::routines_disable,
                     commands::routines_run_now,
                     commands::routines_run_history,
                     commands::routines_stats,
                     commands::routines_cloud_config,
                     commands::routines_cloud_set_config,
                     commands::routines_sync,
                     commands::routines_generate_from_task,
