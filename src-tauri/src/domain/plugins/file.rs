...
impl DomainPlugin for FilePlugin {
    ...
    fn actions(&self) -> Vec<ActionSpec> {
        vec![
            ...
            ActionSpec {
                name: "tree".into(),
                description: "列出目录树".into(),
                params: vec![
                    ParamSpec {
                        name: "path".into(),
                        r#type: "string".into(),
                        description: "目录路径".into(),
                        optional: true,
                    },
                    ParamSpec {
                        name: "max_depth".into(),
                        r#type: "number".into(),
                        description: "最大深度".into(),
                        optional: true,
                    },
                ],
            ...
            ActionSpec {
                name: "diff".into(),
                description: "显示文件 git diff".into(),
                params: vec![ParamSpec {
                    name: "path".into(),
                    r#type: "string".into(),
                    description: "文件路径".into(),
