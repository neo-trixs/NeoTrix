...
use crate::ir::{Module, TestCase, TestSuite};
...
/// Bridge: parse a .nt file as a Module (Phase 2).
/// Reuses parse_file internally and converts TestSuite → Module.
#[allow(dead_code)]
pub fn parse_module(path: &Path) -> Result<Module, String> {
