...
impl KnowledgeSource {
    ...
    pub fn name(&self) -> &'static str {
        match self {
            ...
            KnowledgeSource::Geist => "vercel/geist",
            KnowledgeSource::VisualTasteLab => "visual-taste-lab",
            KnowledgeSource::DecantrDesign => "decantr-design",
            KnowledgeSource::UIReasoning => "ui-reasoning",
            KnowledgeSource::UISkill => "ui-skill",
        }
    }
    ...
    pub fn source_weight(&self) -> f64 {
        match self {
            ...
            KnowledgeSource::Geist => 0.88,
            KnowledgeSource::VisualTasteLab => 0.85,
            KnowledgeSource::DecantrDesign => 0.82,
            KnowledgeSource::UIReasoning => 0.86,
            KnowledgeSource::UISkill => 0.84,
        }
    }
