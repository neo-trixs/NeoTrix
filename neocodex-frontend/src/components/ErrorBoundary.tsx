    ...
    <SolidErrorBoundary
      fallback={(err, reset) => (
        <div class="flex h-full min-h-[100vh] items-center justify-center bg-bg-primary p-8">
          <div class="max-w-lg rounded-lg border border-border-primary bg-bg-secondary p-6">
            ...
            <button
              onClick={() => reset()}
              class="rounded-md bg-border-focus px-4 py-2 text-[13px] font-medium text-white transition-colors hover:bg-border-focus/90"
            >
              重试
            </button>
          </div>
