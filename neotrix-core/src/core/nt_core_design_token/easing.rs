...
impl Default for EasingCurve {
    fn default() -> Self {
        EasingCurve::CubicBezier { x1: 0.4, y1: 0.0, x2: 0.2, y2: 1.0 }
    }
}
...
impl Default for EntranceAnimation {
    fn default() -> Self {
        EntranceAnimation {
            ...
            easing: EasingCurve::CubicBezier { x1: 0.0, y1: 0.0, x2: 0.2, y2: 1.0 },
            duration_ms: 300,
            delay_ms: 0,
            rise_distance: 16.0,
            blur_radius: 8.0,
    ...
    pub fn compound_entrance() -> Vec<EntranceAnimation> {
        vec![
            ...
            EntranceAnimation {
                ...
                easing: EasingCurve::CubicBezier { x1: 0.34, y1: 1.56, x2: 0.64, y2: 1.0 },
                duration_ms: 350,
                delay_ms: 80,
                rise_distance: 20.0,
                blur_radius: 0.0,
...
mod tests {
    ...
    fn test_cubic_bezier_range() {
        let curve = EasingCurve::CubicBezier { x1: 0.4, y1: 0.0, x2: 0.2, y2: 1.0 };
