...
mod tests {
    ...
    fn test_reasoning_bank_stats_default() {
        let s = ReasoningBankStats { total_memories: 0, success_count: 0, success_rate: 0.0 };
    ...
    fn test_reasoning_bank_stats_success_rate() {
        let s = ReasoningBankStats { total_memories: 10, success_count: 7, success_rate: 0.7 };
    ...
    fn test_memory_detailed_stats_fields() {
        let s = MemoryDetailedStats {
            total: 100, tier_working: 30, tier_episodic: 30,
            tier_semantic: 20, tier_procedural: 20,
            avg_confidence: 0.75, avg_importance: 0.6,
        };
    ...
    fn test_memory_detailed_stats_tier_sum() {
        let s = MemoryDetailedStats {
            total: 100, tier_working: 25, tier_episodic: 25,
            tier_semantic: 25, tier_procedural: 25,
            avg_confidence: 0.5, avg_importance: 0.5,
        };
