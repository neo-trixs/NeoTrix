...
impl KnowledgeSource {
    ...
    pub fn name(&self) -> &'static str {
        match self {
            ...
            KnowledgeSource::AlphaXiv => "alphaxiv.org/research-discussion",
            KnowledgeSource::HarnessX => "Darwin-Agent/HarnessX",
            KnowledgeSource::AgiToAsi => "google-deepmind/agi-to-asi",
            KnowledgeSource::MsaSparseAttention => "MiniMax-AI/MSA",
            KnowledgeSource::ExpRl => "exp-rl-exploratory-rl",
            KnowledgeSource::VibeThinker3B => "WeiboAI/VibeThinker",
            KnowledgeSource::Glm52 => "z-ai/glm-5-2",
            KnowledgeSource::QwenRobotWorld => "qwen-robotworld",
            KnowledgeSource::VisualClaw => "visualclaw-agent",
            _ => "external/unknown",
        }
    }
    ...
    pub fn source_weight(&self) -> f64 {
        match self {
            ...
            KnowledgeSource::AlphaXiv => 0.82,
            KnowledgeSource::HarnessX => 0.92,
            KnowledgeSource::AgiToAsi => 0.95,
            KnowledgeSource::MsaSparseAttention => 0.88,
            KnowledgeSource::ExpRl => 0.86,
            KnowledgeSource::VibeThinker3B => 0.84,
            KnowledgeSource::Glm52 => 0.90,
            KnowledgeSource::QwenRobotWorld => 0.85,
            KnowledgeSource::VisualClaw => 0.87,
            // 🆕 2026-06-23: Design consciousness sources
            KnowledgeSource::Geist => 0.90,
            KnowledgeSource::VisualTasteLab => 0.85,
            KnowledgeSource::DecantrDesign => 0.80,
            KnowledgeSource::UIReasoning => 0.88,
            KnowledgeSource::UISkill => 0.82,
        }
    }
