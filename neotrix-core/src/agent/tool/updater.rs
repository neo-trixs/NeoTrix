...
mod tests {
    ...
    impl AgentTool for TestTool {
        ...
        fn start(
            &mut self,
            _api: crate::agent::tool::lifecycle::ToolApi,
        ) -> Result<(), crate::agent::tool::lifecycle::ToolError> {
            Ok(())
        }
        fn execute(
            &self,
            _ctx: crate::agent::tool::lifecycle::ToolContext,
        ) -> Result<
            crate::agent::tool::lifecycle::ToolOutput,
            crate::agent::tool::lifecycle::ToolError,
        > {
