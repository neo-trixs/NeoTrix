...
use super::cleanup::CleanupEngine;
use super::plugin::registry::PluginRegistry;
use super::nt_world_model::WorldModelV2;
use super::evolution_loop::EvolutionLoop;
use super::evolution_daemon::EvolutionDaemon;
...
use super::agent_protocol::discovery::AgentDiscovery;
use super::agent_protocol::capabilities::CapabilityRouter;
...
use super::consciousness_gold_standard::ConsciousnessGoldStandard;
use super::consciousness_monitor::ConsciousnessMonitor;

pub use super::background_config::{BackgroundConfig, TelemetryCollector, TelemetrySnapshot};
...
pub struct BackgroundLoop {
    ...
    pub nt_shield_manager: Option<super::stealth_net::nt_shield_manager::StealthManager>,
    #[cfg(feature = "stealth-net")]
    pub tor_crawler: Option<std::sync::Arc<super::stealth_net::tor_crawler::TorCrawler>>,
    #[cfg(feature = "stealth-net")]
    pub heartbeat_engine: Option<super::stealth_net::ProxyHeartbeatEngine>,
    #[cfg(feature = "stealth-net")]
    pub world_consciousness: Option<crate::neotrix::nt_world_sense::WorldConsciousness>,
    #[cfg(feature = "stealth-net")]
    pub proxy_client: Option<super::stealth_net::proxy_control::ProxyClient>,
...
impl BackgroundLoop {
    pub fn new(brain: Arc<RwLock<SelfIteratingBrain>>) -> Self {
        Self {
            ...
            #[cfg(feature = "stealth-net")]
            nt_shield_manager: Some(super::stealth_net::nt_shield_manager::StealthManager::new(5)),
            #[cfg(feature = "stealth-net")]
            tor_crawler: None,
            #[cfg(feature = "stealth-net")]
