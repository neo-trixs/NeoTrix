...
impl BackgroundLoop {
    ...
    pub fn with_tor_crawler(mut self, tor_crawler: std::sync::Arc<super::super::stealth_net::tor_crawler::TorCrawler>) -> Self {
    ...
    pub fn with_proxy_heartbeat(mut self, interval_secs: u64) -> Self {
        use super::super::stealth_net::{ProxyHeartbeatEngine, FingerprintManager};
        use super::super::stealth_net::proxy_pool::ProxyPool;
        use std::sync::Arc;
    ...
    pub fn with_builtin_plugins(self) -> Self {
        ...
        let _ = rt.block_on(async {
            let logging: Box<dyn crate::neotrix::plugin::Plugin> =
                Box::new(crate::neotrix::plugin::builtin::logging::LoggingPlugin);
    ...
    pub fn with_proxy_client(mut self) -> Self {
        self.proxy_client = Some(super::super::stealth_net::proxy_control::ProxyClient::new());
        self
    }
