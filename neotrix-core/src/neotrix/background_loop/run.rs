...
impl BackgroundLoop {
    pub async fn start(&mut self) {
        ...
        if self.agent_discovery.is_some() {
            let server = std::sync::Arc::new(super::super::agent_protocol::tcp_server::AgentServer::new(42070));
    ...
    async fn handle_always_on(&mut self) {
        use crate::neotrix::background_loop::always_on::AlwaysOnEngine;
    ...
    async fn handle_proxy_auto_mode(&self) {
        use super::super::stealth_net::proxy_control::DaemonMode;
    ...
    async fn handle_plugin_tick(&self) {
        use crate::neotrix::plugin::PluginEvent;
