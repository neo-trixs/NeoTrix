...
use crate::neotrix::http_factory::{TlsVariant, H2SettingsProfile};
...
mod tests {
    use super::*;
    use crate::neotrix::http_factory::{TlsVariant, H2SettingsProfile};
    use crate::neotrix::stealth_net::system_fingerprint::Platform;
    ...
    fn test_bandit_converges_to_best_arm() {
        ...
        for tls in crate::neotrix::http_factory::TlsVariant::all() {
            for plat in crate::neotrix::stealth_net::system_fingerprint::Platform::all().iter().take(3) {
                for h2 in H2SettingsProfile::all() {
