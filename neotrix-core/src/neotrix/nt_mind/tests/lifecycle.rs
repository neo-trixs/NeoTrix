...
mod tests {
    ...
    fn test_prune_expired() {
        ...
        let m1 =
            ReasoningMemory::new("keep me", TaskType::UIDesign, &micro_edits, 0.9).with_ttl(999999);
        bank.store(m1);

        let m2 =
            ReasoningMemory::new("expire me", TaskType::CodeReview, &micro_edits, 0.8).with_ttl(0);
        bank.store(m2);
        ...
        assert!(bank
            .memories()
            .iter()
            .all(|m| m.task_description == "keep me"));
    }
