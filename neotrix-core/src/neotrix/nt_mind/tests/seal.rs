...
mod tests {
    ...
    use crate::neotrix::nt_mind::{ReasoningMemory, SelfIteratingBrain};
    ...
    fn test_seal_loop_with_embedding() {
        ...
        let memories =
            system
                .reasoning_bank
                .retrieve_relevant_by_embedding(&embedding_clone, None, 1);
    ...
    fn test_seal_with_memory() {
        ...
        let memories = system
            .reasoning_bank
            .retrieve_relevant("accessibility", None, 5);
        assert!(!memories.is_empty());
    }
