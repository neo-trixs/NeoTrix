...
impl ContextTier {
    /// 从 RouterTier 映射到 ContextTier
    pub fn from_model_tier(tier: RouterTier) -> Self {
        match tier {
            RouterTier::T0 => Self::Small,
            RouterTier::T1 => Self::Small,
            RouterTier::T2 => Self::Medium,
            RouterTier::T3 => Self::Large,
            RouterTier::T4 => Self::Massive,
        }
    }
