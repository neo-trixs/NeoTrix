...
use super::{HyperAgentRecord, ParentSelection};
...
impl HyperMetaAgent {
    ...
    fn mutate_from_parent(
        &self,
        parent: &HyperAgentRecord,
        ...
        } else if archive.config.strategy == ParentSelection::DiversityWeighted
            && parent.novelty_score > 0.5
        {
