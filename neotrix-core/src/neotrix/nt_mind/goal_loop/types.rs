...
impl GoalLoopState {
    pub fn is_terminal(&self) -> bool {
        matches!(
            self,
            GoalLoopState::Achieved | GoalLoopState::Unmet | GoalLoopState::BudgetLimited
        )
    }

    pub fn label(&self) -> &str {
        match self {
            GoalLoopState::Pursuing => "pursuing",
            GoalLoopState::Paused => "paused",
            GoalLoopState::Achieved => "achieved",
            GoalLoopState::Unmet => "unmet",
            GoalLoopState::BudgetLimited => "budget_limited",
        }
    }
