...
mod tests {
    ...
    fn test_prd_input_with_stories() {
        ...
        input
            .user_stories
            .push("As a user, I can create tasks".to_string());
        input
            .user_stories
            .push("As a user, I can set due dates".to_string());
    ...
    fn test_prd_prompt_with_competitive_context() {
        ...
        input
            .competitive_context
            .push("Notion has a rich editor".to_string());
        input
            .competitive_context
            .push("Obsidian has local-first sync".to_string());
        let prompt = build_prd_prompt(&input);
