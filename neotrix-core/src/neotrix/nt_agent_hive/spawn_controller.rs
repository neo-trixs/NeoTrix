...
use super::types::*;
use crate::core::nt_core_meta::knowledge_gap_detector::{GapCategory, GapReport, KnowledgeGap};
...
impl SpawnController {
    pub fn new(registry: SubHiveRegistry) -> Self {
        SpawnController {
            registry,
    ...
    fn spec_for_cluster(
        &self,
        cluster: &crate::core::nt_core_meta::knowledge_gap_detector::GapCluster,
    ) -> SubHiveSpec {
...
mod tests {
    ...
    fn controller() -> SpawnController {
        SpawnController::new(SubHiveRegistry::new())
    }
