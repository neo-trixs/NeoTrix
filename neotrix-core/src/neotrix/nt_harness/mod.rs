...
impl HarnessGateway {
    ...
    pub fn execute_real(&self, req: HarnessExecuteRequest, report: &TaskLoopReport) -> HarnessExecuteResponse {
        ...
        let run_id = crate::l3_embodiment::nt_shield::nt_shield::receipt::hash_content(&req.instruction);
...
mod tests {
    ...
    fn execute_real_emits_verifiable_receipt() {
        ...
        assert_eq!(receipt.output_hash, crate::l3_embodiment::nt_shield::nt_shield::receipt::hash_content(&resp.message));
    }
}
