...
pub fn canonical_catalog_fingerprint(hexagram_ids: &[usize], specialist_names: &[String]) -> String {
...
mod tests {
    ...
    fn test_sort_specialist_names() {
        let mut names = vec!["memory".to_string(), "attention".to_string(), "self_model".to_string()];
