...
impl TokenRegistry {
    ...
    fn load_presets(&mut self) {
        ...
        for (name, desc, x1, y1, x2, y2) in &[
            (
                "easing-standard",
                "Standard ease — both ends smooth",
                0.4,
                0.0,
                0.2,
                1.0,
            ...
            (
                "easing-entrance",
                "Entrance — decelerate into place",
                0.0,
                0.0,
                0.2,
                1.0,
            ...
            (
                "easing-emphasis",
                "Emphasis — overshoot for attention",
                0.4,
                0.0,
                0.6,
                1.0,
            ...
            (
                "easing-spring-expressive",
                "Expressive spring — subtle bounce",
                0.34,
                1.56,
                0.64,
                1.0,
            ...
            (
                "easing-spring-standard",
                "Standard spring — minimal bounce",
                0.34,
                0.8,
                0.64,
                1.0,
        ...
        for (name, desc, val) in &[
            (
                "zoompan-speed",
                "Logo reveal zoom decay per frame",
                TokenValue::Opacity(0.015),
            ),
            (
                "zoompan-fast",
                "Awakening fast zoom decay per frame",
                TokenValue::Opacity(0.04),
            ),
            (
                "zoompan-slow",
                "Brand film slow zoom decay per frame",
                TokenValue::Opacity(0.01),
            ),
            (
                "zoompan-moderate",
                "Hello world moderate zoom decay per frame",
                TokenValue::Opacity(0.025),
            ),
            (
                "zoompan-manifesto",
                "Manifesto-60s zoom decay per frame",
                TokenValue::Opacity(0.03),
            ),
            (
                "flow-field-width",
                "Flow/Conway life base render width px",
                TokenValue::Spacing(640.0),
            ),
            (
                "flow-field-height",
                "Flow/Conway life base render height px",
                TokenValue::Spacing(360.0),
            ),
            (
                "grain-opacity",
                "Film grain overlay opacity",
                TokenValue::Opacity(0.02),
            ),
            (
                "resolution-hd-width",
                "HD video width px",
                TokenValue::Spacing(1920.0),
            ),
            (
                "resolution-hd-height",
                "HD video height px",
                TokenValue::Spacing(1080.0),
            ),
            (
                "resolution-2k-width",
                "2K video width px",
                TokenValue::Spacing(2560.0),
            ),
            (
                "resolution-2k-height",
                "2K video height px",
                TokenValue::Spacing(1440.0),
            ),
            (
                "zoompan-2k-base",
                "2K zoompan base zoom value",
                TokenValue::Opacity(1.02),
            ),
            (
                "zoompan-2k-factor",
                "2K zoompan ramping factor",
                TokenValue::Opacity(0.04),
            ),
        ] {
            let ttype = match val {
                ...
                _ => {
                    log::warn!(
                        "unexpected TokenValue variant in register_defaults, defaulting to Opacity"
                    );
                    TokenType::Opacity
                }
            };
