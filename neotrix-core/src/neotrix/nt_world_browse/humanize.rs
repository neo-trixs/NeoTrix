...
mod tests {
    ...
    fn test_humanizer_default_equals_new() {
        assert_eq!(
            Humanizer::default().typing_speed,
            Humanizer::new().typing_speed
        );
    }
    ...
    fn test_jitter_ms_increases_base() {
        ...
        for base in [50u64, 100, 500, 1000] {
            ...
            assert!(
                j <= base + max_jitter,
                "jitter {} too high for base {} (max_jitter {})",
                j,
                base,
                max_jitter
            );
    ...
    fn test_simulate_page_read_zero() {
        ...
        assert!(
            d.as_millis() >= 300 && d.as_millis() < 1500,
            "zero text read {}ms",
            d.as_millis()
        );
    }
