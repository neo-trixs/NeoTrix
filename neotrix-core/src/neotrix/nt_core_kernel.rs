...
use crate::neotrix::nt_world_browse::circuits_types::{
    ReasoningMethod, ReasoningOutput, ReasoningTrace,
};
...
pub const EVOLUTION: &[StageInfo] = &[
    ...
    StageInfo {
        label: "Stage 3",
        description: "Analogy Engine",
    },
    StageInfo {
        label: "Stage 4",
        description: "Recursive Reasoner",
    },
    StageInfo {
        label: "Stage 5",
    ...
    StageInfo {
        label: "Stage 10",
        description: "Gradient Learning",
    },
    StageInfo {
        label: "Stage 11",
        description: "Architecture Search",
    },
    StageInfo {
        label: "Stage 12",
    ...
    StageInfo {
        label: "Stage 14",
        description: "Experience Distill",
    },
    StageInfo {
        label: "Stage 15",
        description: "Emergent Analysis",
    },
    StageInfo {
        label: "Stage 16",
...
impl ReasoningKernel {
    ...
    pub fn reason(
        &self,
        _query: &[f64],
        _context: Option<HashMap<String, Vector>>,
    ) -> ReasoningOutput {
        ReasoningOutput {
    ...
    pub fn stats(&self) -> KernelStats {
        KernelStats {
            ...
            energy: self.state.iter().map(|x| x.abs()).sum::<f64>()
