...
mod tests {
    ...
    fn test_template_detect_robustness() {
        ...
        let cases = vec![
            ...
            vec!["A".into()],
            vec![
                "序号".into(), "名称".into(), "口径".into(), "配置".into(),
                "数量".into(), "单位".into(), "单价/元".into(), "总价/元".into(),
                "单重kg".into(), "总重kg".into(),
            ],
            vec![
                "序号".into(), "产品名称".into(), "型号".into(), "口径".into(),
                "配置".into(), "订单数量".into(), "单位".into(), "单价/元".into(),
                "总价/元".into(), "单重kg".into(), "总重kg".into(),
            ],
