...
impl UsgsFetcher {
    ...
    pub fn to_search_results(events: &[UsgsEvent]) -> Vec<crate::neotrix::l2_world_impl::nt_world_search::SearchResult> {
...
pub fn usgs_egress_rule() -> crate::neotrix::l1_body_impl::nt_shield_sandbox::EgressRule {
    crate::neotrix::l1_body_impl::nt_shield_sandbox::EgressRule::allow(USGS_HOST, "443")
}
pub fn usgs_egress_policy() -> crate::neotrix::l1_body_impl::nt_shield_sandbox::EgressPolicy {
    crate::neotrix::l1_body_impl::nt_shield_sandbox::EgressPolicy::new(vec![usgs_egress_rule()], false)
}
...
impl crate::neotrix::l2_world_impl::nt_world_search::SearchBackend for UsgsBackend {
