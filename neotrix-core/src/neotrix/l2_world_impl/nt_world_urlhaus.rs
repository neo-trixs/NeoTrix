...
impl UrlhausFetcher {
    ...
    pub fn to_search_results(events: &[UrlhausEvent]) -> Vec<crate::neotrix::l2_world_impl::nt_world_search::SearchResult> {
...
impl CisaKevFetcher {
    ...
    pub fn to_search_results(events: &[CisaKevEvent]) -> Vec<crate::neotrix::l2_world_impl::nt_world_search::SearchResult> {
        events.iter().map(|e| crate::neotrix::l2_world_impl::nt_world_search::SearchResult {
...
pub fn urlhaus_egress_rule() -> crate::neotrix::l1_body_impl::nt_shield_sandbox::EgressRule {
    crate::neotrix::l1_body_impl::nt_shield_sandbox::EgressRule::allow(URLHAUS_HOST, "443")
}
pub fn urlhaus_egress_policy() -> crate::neotrix::l1_body_impl::nt_shield_sandbox::EgressPolicy {
    crate::neotrix::l1_body_impl::nt_shield_sandbox::EgressPolicy::new(vec![urlhaus_egress_rule()], false)
}
pub fn cisa_kev_egress_rule() -> crate::neotrix::l1_body_impl::nt_shield_sandbox::EgressRule {
    crate::neotrix::l1_body_impl::nt_shield_sandbox::EgressRule::allow(CISA_KEV_HOST, "443")
}
pub fn cisa_kev_egress_policy() -> crate::neotrix::l1_body_impl::nt_shield_sandbox::EgressPolicy {
    crate::neotrix::l1_body_impl::nt_shield_sandbox::EgressPolicy::new(vec![cisa_kev_egress_rule()], false)
}
...
impl crate::neotrix::l2_world_impl::nt_world_search::SearchBackend for UrlhausBackend {
