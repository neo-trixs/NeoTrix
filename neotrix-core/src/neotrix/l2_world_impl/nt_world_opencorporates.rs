...
fn company_to_search(c: &OcCompanyDetail) -> crate::neotrix::l2_world_impl::nt_world_search::SearchResult {
    let url = format!(
    ...
    crate::neotrix::l2_world_impl::nt_world_search::SearchResult {
        title: c.name.clone(),
        url,
        snippet,
        evidence: None,
...
impl OpencorporatesFetcher {
    ...
    pub fn to_search_results(companies: &[OcCompanyDetail]) -> Vec<crate::neotrix::l2_world_impl::nt_world_search::SearchResult> {
...
pub fn opencorporates_egress_rule() -> crate::neotrix::l1_body_impl::nt_shield_sandbox::EgressRule {
    crate::neotrix::l1_body_impl::nt_shield_sandbox::EgressRule::allow(OPENCORPORATES_HOST, "443")
}
pub fn opencorporates_egress_policy() -> crate::neotrix::l1_body_impl::nt_shield_sandbox::EgressPolicy {
    crate::neotrix::l1_body_impl::nt_shield_sandbox::EgressPolicy::new(vec![opencorporates_egress_rule()], false)
}
...
impl crate::neotrix::l2_world_impl::nt_world_search::SearchBackend for OpencorporatesBackend {
