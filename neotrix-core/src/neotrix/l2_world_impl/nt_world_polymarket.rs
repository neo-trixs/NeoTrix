...
impl PolymarketFetcher {
    ...
    pub fn to_search_results(events: &[PolymarketMarket]) -> Vec<crate::neotrix::l2_world_impl::nt_world_search::SearchResult> {
...
pub fn polymarket_egress_rule() -> crate::neotrix::l1_body_impl::nt_shield_sandbox::EgressRule {
    crate::neotrix::l1_body_impl::nt_shield_sandbox::EgressRule::allow(POLYMARKET_HOST, "443")
}
pub fn polymarket_egress_policy() -> crate::neotrix::l1_body_impl::nt_shield_sandbox::EgressPolicy {
    crate::neotrix::l1_body_impl::nt_shield_sandbox::EgressPolicy::new(vec![polymarket_egress_rule()], false)
}
...
impl crate::neotrix::l2_world_impl::nt_world_search::SearchBackend for PolymarketBackend {
