...
impl EdgarFetcher {
    ...
    pub fn to_search_results(filings: &[EdgarFiling]) -> Vec<crate::neotrix::l2_world_impl::nt_world_search::SearchResult> {
        filings
            .iter()
            .map(|f| crate::neotrix::l2_world_impl::nt_world_search::SearchResult {
...
pub fn edgar_egress_rule() -> crate::neotrix::l1_body_impl::nt_shield_sandbox::EgressRule {
    crate::neotrix::l1_body_impl::nt_shield_sandbox::EgressRule::allow(EDGAR_HOST, "443")
}
/// SEC EDGAR 专用 Egress Policy (deny_all 基线 + 单条 allow)。
pub fn edgar_egress_policy() -> crate::neotrix::l1_body_impl::nt_shield_sandbox::EgressPolicy {
    crate::neotrix::l1_body_impl::nt_shield_sandbox::EgressPolicy::new(vec![edgar_egress_rule()], false)
}
...
impl crate::neotrix::l2_world_impl::nt_world_search::SearchBackend for EdgarBackend {
    fn name(&self) -> &str {
        "edgar"
    }
    fn search(&self, _query: &str, _count: usize) -> Result<Vec<crate::neotrix::l2_world_impl::nt_world_search::SearchResult>, String> {
...
mod tests {
    ...
    fn test_egress_policy_allows_edgar_denies_other() {
        ...
        with_deny.rules.push(crate::neotrix::l1_body_impl::nt_shield_sandbox::EgressRule::deny(EDGAR_HOST, "443"));
    ...
    fn test_ingest_fixture_to_kb_and_requery() {
        ...
        // FTS 搜索可回查
        let hits = kb.search_permission_aware("Apple", 10, crate::neotrix::l3_memory_impl::nt_memory_kb::nt_memory_types::PermissionLevel::Public).expect("search");
