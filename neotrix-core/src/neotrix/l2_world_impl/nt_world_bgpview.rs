...
fn result_to_search(r: &BgpviewResult) -> crate::neotrix::l2_world_impl::nt_world_search::SearchResult {
...
impl BgpviewFetcher {
    ...
    pub fn to_search_results(results: &[BgpviewResult]) -> Vec<crate::neotrix::l2_world_impl::nt_world_search::SearchResult> {
...
pub fn bgpview_egress_rule() -> crate::neotrix::l1_body_impl::nt_shield_sandbox::EgressRule {
    crate::neotrix::l1_body_impl::nt_shield_sandbox::EgressRule::allow(BGPVIEW_HOST, "443")
}
pub fn bgpview_egress_policy() -> crate::neotrix::l1_body_impl::nt_shield_sandbox::EgressPolicy {
    crate::neotrix::l1_body_impl::nt_shield_sandbox::EgressPolicy::new(vec![bgpview_egress_rule()], false)
}
...
impl crate::neotrix::l2_world_impl::nt_world_search::SearchBackend for BgpviewBackend {
