...
impl GdacsFetcher {
    ...
    pub fn to_search_results(events: &[GdacsEvent]) -> Vec<crate::neotrix::l2_world_impl::nt_world_search::SearchResult> {
...
pub fn gdacs_egress_rule() -> crate::neotrix::l1_body_impl::nt_shield_sandbox::EgressRule {
    crate::neotrix::l1_body_impl::nt_shield_sandbox::EgressRule::allow(GDACS_HOST, "443")
}
pub fn gdacs_egress_policy() -> crate::neotrix::l1_body_impl::nt_shield_sandbox::EgressPolicy {
    crate::neotrix::l1_body_impl::nt_shield_sandbox::EgressPolicy::new(vec![gdacs_egress_rule()], false)
}
...
impl crate::neotrix::l2_world_impl::nt_world_search::SearchBackend for GdacsBackend {
