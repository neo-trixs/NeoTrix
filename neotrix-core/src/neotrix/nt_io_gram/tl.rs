...
mod tests {
    ...
    fn test_write_read_int32() {
        ...
        assert_eq!(
            r.read_int32()
                .expect("first int32 from freshly written buffer should be 42"),
            42
        );
        assert_eq!(
            r.read_int32()
                .expect("second int32 from freshly written buffer should be -1"),
            -1
        );
    }
    ...
    fn test_write_read_string() {
        ...
        assert_eq!(
            r.read_string()
                .expect("read_string for 'Hello NeoTrix' should succeed"),
            "Hello NeoTrix"
        );
    }
    ...
    fn test_write_read_bytes() {
        ...
        assert_eq!(
            r.read_bytes()
                .expect("read_bytes should return the written bytes"),
            data
        );
    }
    ...
    fn test_serialize_error() {
        ...
        assert_eq!(
            r.read_uint32()
                .expect("serialize_error should start with error constructor ID"),
            0x2144ca19
        );
        assert_eq!(
            r.read_int32()
                .expect("serialize_error should contain 404 error code"),
            404
        );
        assert_eq!(
            r.read_string()
                .expect("serialize_error should contain 'NOT_FOUND' message"),
            "NOT_FOUND"
        );
    }
