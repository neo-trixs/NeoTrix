...
impl Default for VideoScriptPlanner {
    fn default() -> Self {
        Self::new()
    }
}
...
impl VideoScriptPlanner {
    ...
    pub fn with_llm(provider: Box<dyn crate::neotrix::nt_io_provider::types::LlmProvider>) -> Result<Self, String> {
        match tokio::runtime::Runtime::new() {
            Ok(runtime) => Ok(Self { llm: Some((runtime, provider)) }),
