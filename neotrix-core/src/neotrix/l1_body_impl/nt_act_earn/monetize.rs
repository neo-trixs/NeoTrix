...
impl AiToEarnBridge {
    ...
    fn mcp_request(&self, method: &str, params: serde_json::Value) -> Result<serde_json::Value, String> {
    ...
    pub fn publish_content(&self, req: &PublishRequest) -> Result<PublishResult, String> {
        ...
        serde_json::from_value(result)
            .map_err(|e| format!("PublishResult parse failed: {}", e))
    }
    ...
    pub fn list_tasks(&self) -> Result<Vec<TaskInfo>, String> {
        ...
        serde_json::from_value(result)
            .map_err(|e| format!("TaskInfo parse failed: {}", e))
    }
    ...
    pub fn check_earnings(&self) -> Result<EarningsReport, String> {
        ...
        serde_json::from_value(result)
            .map_err(|e| format!("EarningsReport parse failed: {}", e))
    }
    ...
    pub fn list_platforms(&self) -> Result<Vec<String>, String> {
        ...
        serde_json::from_value(result)
            .map_err(|e| format!("Platform list parse failed: {}", e))
    }
    ...
    pub fn fetch_real_earnings_reward(&self) -> Result<(f64, Vec<(String, f64)>), String> {
        ...
        let breakdown: Vec<(String, f64)> = report.platform_breakdown.iter()
