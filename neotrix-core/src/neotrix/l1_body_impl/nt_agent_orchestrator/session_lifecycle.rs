...
impl SessionState {
    ...
    pub fn can_transition_to(&self, next: &SessionState) -> bool {
        ...
        matches!((self, next),
            (SessionState::Spawning, SessionState::Working)
            | (SessionState::Spawning, SessionState::Killed)
            | (SessionState::Spawning, SessionState::Failed)
            | (SessionState::Working, SessionState::PrOpen)
            | (SessionState::Working, SessionState::Killed)
            | (SessionState::Working, SessionState::Failed)
            | (SessionState::PrOpen, SessionState::CiFailed)
            | (SessionState::PrOpen, SessionState::ReviewPending)
            | (SessionState::PrOpen, SessionState::Merged)
            | (SessionState::PrOpen, SessionState::Killed)
            | (SessionState::CiFailed, SessionState::Working)
            | (SessionState::CiFailed, SessionState::Killed)
            | (SessionState::CiFailed, SessionState::Failed)
            | (SessionState::ReviewPending, SessionState::ChangesRequested)
            | (SessionState::ReviewPending, SessionState::Approved)
            | (SessionState::ReviewPending, SessionState::Killed)
            | (SessionState::ChangesRequested, SessionState::Working)
            | (SessionState::ChangesRequested, SessionState::Killed)
            | (SessionState::Approved, SessionState::Mergeable)
            | (SessionState::Mergeable, SessionState::Merged)
            | (SessionState::Merged, SessionState::Cleanup)
            | (SessionState::Cleanup, SessionState::Done)
