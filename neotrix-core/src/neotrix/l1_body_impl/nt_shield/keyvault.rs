...
fn load_master_key() -> L1Result<[u8; 32]> {
...
fn encrypt_value(cipher: &Aes256Gcm, plaintext: &str) -> L1Result<String> {
...
fn decrypt_value(cipher: &Aes256Gcm, encoded: &str) -> L1Result<String> {
...
impl LocalStore {
    fn new() -> L1Result<Self> {
        let path = shellexpand::tilde(STORAGE_PATH).parse::<PathBuf>()
            .map_err(|_| L1Error::Config("Failed to expand keyvault path".into()))?;
    ...
    #[cfg(test)]
    fn new_with_path(path: PathBuf, key: &[u8; 32]) -> L1Result<Self> {
    ...
    fn set(&self, key: &str, value: &str) -> L1Result<()> {
    ...
    fn get(&self, key: &str) -> L1Result<Option<String>> {
...
impl KeyringStore {
    ...
    fn set(&self, key: &str, value: &str) -> L1Result<()> {
        ...
        entry.set_password(value)
            .map_err(|e| L1Error::Keyring(format!("Keyring set failed: {}", e)))?;
        Ok(())
    }
    ...
    fn get(&self, key: &str) -> L1Result<Option<String>> {
        ...
        match entry.get_password() {
            ...
            Err(e) => Err(L1Error::Keyring(format!("Keyring get failed: {}", e))),
        }
    }
...
impl KeyVault {
    ...
    pub fn set(&self, key: &str, value: &str) -> L1Result<()> {
    ...
    pub fn get(&self, key: &str) -> L1Result<Option<String>> {
        #[cfg(feature = "keyring")]
        {
    ...
    pub fn delete(&self, key: &str) -> L1Result<()> {
    ...
    pub fn list(&self) -> L1Result<Vec<String>> {
