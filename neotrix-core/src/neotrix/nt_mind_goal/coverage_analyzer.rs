...
"#,
        ...
        create_test_file(
            &root,
            "src/test_mod/with_test_attr.rs",
            r#"
#[test]
...
"#,
    ...
    fn test_custom_modules_list() {
        ...
        let analyzer = CoverageAnalyzer::with_modules(root, vec!["alpha".into(), "gamma".into()]);
        let report = analyzer.analyze();
...
"#,
    ...
    fn test_is_test_file_detection() {
        ...
        create_test_file(
            &root,
            "src/detect_mod/has_cfg_test.rs",
            r#"
#[cfg(test)]
mod tests {
    #[test]
...
"#,
        ...
        create_test_file(
            &root,
            "src/detect_mod/has_test_attr.rs",
            r#"
#[test]
fn standalone() {}
"#,
