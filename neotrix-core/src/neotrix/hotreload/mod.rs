...
pub fn default_watcher(
    neotrix_dir: PathBuf,
    rule_engine: Option<std::sync::Arc<tokio::sync::RwLock<crate::neotrix::stealth_net::rules::RuleEngine>>>,
    proxy_pool: Option<std::sync::Arc<crate::neotrix::stealth_net::proxy_pool::ProxyPool>>,
    ...
    watcher.watch("config.toml", "config", move || {
        crate::neotrix::stealth_net::config::reload()
