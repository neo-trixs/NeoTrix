...
macro_rules! log_error {
    ($module:expr, $($arg:tt)*) => {
        $crate::neotrix::nt_io_logging::log(
            $crate::neotrix::nt_io_logging::LEVEL_ERROR, $module,
            &format!($($arg)*)
        )
    };
}
...
macro_rules! log_warn {
    ($module:expr, $($arg:tt)*) => {
        $crate::neotrix::nt_io_logging::log(
            $crate::neotrix::nt_io_logging::LEVEL_WARN, $module,
            &format!($($arg)*)
        )
    };
}
...
macro_rules! log_info {
    ($module:expr, $($arg:tt)*) => {
        $crate::neotrix::nt_io_logging::log(
            $crate::neotrix::nt_io_logging::LEVEL_INFO, $module,
            &format!($($arg)*)
        )
    };
}
...
macro_rules! log_debug {
    ($module:expr, $($arg:tt)*) => {
        $crate::neotrix::nt_io_logging::log(
            $crate::neotrix::nt_io_logging::LEVEL_DEBUG, $module,
            &format!($($arg)*)
        )
    };
}
