...
impl WorldConsciousness {
    ...
    pub fn record_conversation_turn(
        ...
        self.omniscient_view = self
            .omniscient_view
            .from_observer(&self.conversation_observer);
        id
    }
    ...
    pub fn consciousness_status(&self) -> String {
        ...
        let self_awareness = format!(
            ...
            o.self_narrative,
            o.consciousness_scores[0],
            o.consciousness_scores[1],
            o.consciousness_scores[2],
            o.user_model,
        );
        let world_awareness = format!("World-awareness: {}", nt_world_sense_narrative);
        let observer_awareness = match last_turn {
            Some(t) => format!(
                "Observer-awareness: {} turns, last user msg: \"{}\"",
                turn_count, t.user_message
            ),
            None => format!(
                "Observer-awareness: {} turns, awaiting first interaction",
                turn_count
            ),
        };
        ...
        format!(
            ...
            world_awareness,
            observer_awareness,
            o.dialogue_phases.len(),
            o.dialogue_phases,
            o.sentiment_trend,
            if o.repetition_detected {
                format!("yes: {:?}", o.repeated_topics)
            } else {
                "none".to_string()
            },
            o.god_eye_narrative,
            o.capability_summary,
