use crate::core::nt_core_sense::{
    Sensor, SensorSample, SensoryEvent, SensoryEventKind, Transcription,
};
...
impl MicCapture {
    ...
    fn capture_mic_macos(&self) -> Option<SensorSample> {
        ...
        sample
            .metadata
            .insert("duration_secs".into(), self.duration_secs.to_string());
        sample
            .metadata
            .insert("file_size_bytes".into(), meta.len().to_string());
