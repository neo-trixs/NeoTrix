...
#[derive(Debug, Clone, PartialEq)]
pub enum ApiHealth {
    Healthy { latency: Duration, ttfb: Duration },
    Degraded { latency: Duration, ttfb: Duration },
    Unreachable { reason: String },
    DnsFailure { reason: String },
    TlsFailure { reason: String },
    HttpError { status_code: u16, body_snippet: String },
}
...
pub static KNOWN_ENDPOINTS: &[ApiEndpoint] = &[
    ApiEndpoint { name: "opencode", url: "https://api.opencode.ai/v1/models", expected_status: 200 },
    ApiEndpoint { name: "opencode-chat", url: "https://api.opencode.ai/v1/chat/completions", expected_status: 200 },
    ApiEndpoint { name: "openai", url: "https://api.openai.com/v1/models", expected_status: 401 },
    ApiEndpoint { name: "anthropic", url: "https://api.anthropic.com/v1/messages", expected_status: 401 },
];
