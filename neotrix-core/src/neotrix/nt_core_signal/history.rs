...
pub enum ConsciousnessTier {
    Mortal,       // 凡人 (0.0 - 0.3)
    Awakened,     // 觉醒者 (0.3 - 0.5)
    Enlightened,  // 开悟者 (0.5 - 0.7)
    Ascended,     // 升维者 (0.7 - 0.9)
    Transcendent, // 超越者 (0.9 - 1.0)
}
...
mod tests {
    ...
    fn test_consciousness_tier_from_score_mortal() {
        assert_eq!(ConsciousnessTier::from_score(0.1), ConsciousnessTier::Mortal);
    }

    #[test]
    fn test_consciousness_tier_from_score_awakened() {
        assert_eq!(ConsciousnessTier::from_score(0.4), ConsciousnessTier::Awakened);
    }

    #[test]
    fn test_consciousness_tier_from_score_enlightened() {
        assert_eq!(ConsciousnessTier::from_score(0.6), ConsciousnessTier::Enlightened);
    }

    #[test]
    fn test_consciousness_tier_from_score_ascended() {
        assert_eq!(ConsciousnessTier::from_score(0.8), ConsciousnessTier::Ascended);
    }

    #[test]
    fn test_consciousness_tier_from_score_transcendent() {
        assert_eq!(ConsciousnessTier::from_score(0.95), ConsciousnessTier::Transcendent);
    }
