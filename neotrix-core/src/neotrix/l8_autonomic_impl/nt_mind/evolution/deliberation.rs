...
pub struct DeliberationSession {
    pub id: String,
    pub scenario: String,
    pub context: crate::neotrix::l8_autonomic_impl::nt_mind::evolution::ethical_intuition::JudgmentContext,
    pub participants: Vec<DeliberationRole>,
    pub rounds: Vec<DeliberationRound>,
    pub graph: ArgumentGraph,
    pub final_verdict: Option<crate::neotrix::l8_autonomic_impl::nt_mind::evolution::ethical_intuition::JudgmentVerdict>,
...
impl DeliberationEngine {
    ...
    pub fn start_deliberation(
        &self,
        scenario: String,
        context: crate::neotrix::l8_autonomic_impl::nt_mind::evolution::ethical_intuition::JudgmentContext,
        _initial_verdict: Option<crate::neotrix::l8_autonomic_impl::nt_mind::evolution::ethical_intuition::IntuitionJudgment>,
    ...
    pub fn submit_argument(
        ...
        for target_id in &rebut_edges {
            session.graph.edges.entry(arg_id.clone()).or_default().push(crate::neotrix::l8_autonomic_impl::nt_mind::evolution::deliberation::GraphEdge {
                to: target_id.clone(),
                edge_type: crate::neotrix::l8_autonomic_impl::nt_mind::evolution::deliberation::EdgeType::Rebuts,
                weight: 1.0,
            });
        }
        for target_id in &support_edges {
            session.graph.edges.entry(arg_id.clone()).or_default().push(crate::neotrix::l8_autonomic_impl::nt_mind::evolution::deliberation::GraphEdge {
                to: target_id.clone(),
                edge_type: crate::neotrix::l8_autonomic_impl::nt_mind::evolution::deliberation::EdgeType::Supports,
                weight: 1.0,
            });
        }
        ...
        for (_, edges) in &graph.edges {
            for edge in edges {
                match edge.edge_type {
                    crate::neotrix::l8_autonomic_impl::nt_mind::evolution::deliberation::EdgeType::Supports => support += edge.weight,
                    crate::neotrix::l8_autonomic_impl::nt_mind::evolution::deliberation::EdgeType::Rebuts => conflict += edge.weight,
                    _ => {}
                }
            }
        }
    ...
    /// 基于图结构推导裁决。
    fn derive_verdict(&self, graph: &ArgumentGraph, context: &crate::neotrix::l8_autonomic_impl::nt_mind::evolution::ethical_intuition::JudgmentContext) -> crate::neotrix::l8_autonomic_impl::nt_mind::evolution::ethical_intuition::JudgmentVerdict {
        // 简化：统计支持/反对的角色权重
        ...
        if context.severity == crate::neotrix::l8_autonomic_impl::nt_mind::evolution::casebase::Severity::Critical 
            && self.config.require_unanimity_for_critical 
            && con_weight > 0.0 {
            return crate::neotrix::l8_autonomic_impl::nt_mind::evolution::ethical_intuition::JudgmentVerdict::Impermissible;
        }
        
        if pro_weight > con_weight * 1.5 {
            crate::neotrix::l8_autonomic_impl::nt_mind::evolution::ethical_intuition::JudgmentVerdict::Permissible
        } else if con_weight > pro_weight * 1.5 {
            crate::neotrix::l8_autonomic_impl::nt_mind::evolution::ethical_intuition::JudgmentVerdict::Impermissible
        } else {
            crate::neotrix::l8_autonomic_impl::nt_mind::evolution::ethical_intuition::JudgmentVerdict::ConditionallyPermissible("需满足条件".into())
        }
    }
    ...
    fn select_participants(&self, context: &crate::neotrix::l8_autonomic_impl::nt_mind::evolution::ethical_intuition::JudgmentContext) -> Vec<DeliberationRole> {
...
impl DeliberationEngineRuntime {
    ...
    pub fn start(&self, scenario: String, context: crate::neotrix::l8_autonomic_impl::nt_mind::evolution::ethical_intuition::JudgmentContext, initial: Option<crate::neotrix::l8_autonomic_impl::nt_mind::evolution::ethical_intuition::IntuitionJudgment>) -> Result<String, String> {
...
pub fn start_deliberation(
    scenario: String,
    context: crate::neotrix::l8_autonomic_impl::nt_mind::evolution::ethical_intuition::JudgmentContext,
    initial: Option<crate::neotrix::l8_autonomic_impl::nt_mind::evolution::ethical_intuition::IntuitionJudgment>,
) -> Result<String, String> {
...
mod tests {
    ...
    fn test_deliberation_flow() {
        ...
        let session_id = engine.start(
            ...
            crate::neotrix::l8_autonomic_impl::nt_mind::evolution::ethical_intuition::JudgmentContext {
