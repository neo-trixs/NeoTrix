...
#[allow(unused_imports)]
use crate::neotrix::l8_autonomic_impl::nt_mind::evolution::value_compass::{ValueCompassRuntime, ValueCompassStore, ValueAction as CompassAction};
#[allow(unused_imports)]
use crate::neotrix::l8_autonomic_impl::nt_mind::evolution::value_gate::{ValueGate, ValueGateConfig, ValueGateRuntime, GateResult};
#[allow(unused_imports)]
use crate::neotrix::l8_autonomic_impl::nt_mind::evolution::value_learning::{ValueLearningEngine, LearningConfig, record_outcome, Outcome as LearningOutcome};
#[allow(unused_imports)]
use crate::neotrix::l8_autonomic_impl::nt_mind::evolution::autobiographical_index::{AutobiographicalIndex, IndexConfig};
#[allow(unused_imports)]
use crate::neotrix::l8_autonomic_impl::nt_mind::evolution::narrative_self::{NarrativeSelf, NarrativeConfig, NarrativeStats};
#[allow(unused_imports)]
use crate::neotrix::l8_autonomic_impl::nt_mind::evolution::narrative_integrator::{NarrativeIntegrator, NarrativeIntegratorConfig, IntegrationResult, run_narrative_integration};
#[allow(unused_imports)]
...
impl ValueIntegrationRuntime {
    ...
    pub fn process_action(
        ...
        session_id: &str,
    ) -> crate::neotrix::l8_autonomic_impl::nt_mind::evolution::value_gate::GateResult {
    ...
    pub fn record_action_outcome(
        &self,
        action: &crate::neotrix::l8_autonomic_impl::nt_mind::evolution::value_compass::ValueAction,
        outcome: crate::neotrix::l8_autonomic_impl::nt_mind::evolution::value_learning::Outcome,
        session_id: &str,
    ) {
    ...
    /// 获取指南针快照。
    pub fn compass_snapshot(&self) -> crate::neotrix::l8_autonomic_impl::nt_mind::evolution::value_compass::ValueCompass {
    ...
    /// 获取门禁统计。
    pub fn gate_stats(&self) -> crate::neotrix::l8_autonomic_impl::nt_mind::evolution::value_gate::GateStats {
        self.gate.stats()
    }
}
...
#[allow(unused_imports)]
    use crate::neotrix::l8_autonomic_impl::nt_mind::hpa_axis::{HpaAxisState, HpaPhase};
    ...
    pub fn update_hpa_with_values(
        hpa: &mut crate::neotrix::l8_autonomic_impl::nt_mind::hpa_axis::HpaAxisState,
...
#[allow(unused_imports)]
    use crate::neotrix::l8_autonomic_impl::nt_mind::evolution::goal_loop::{GoalLoop, GoalState};
#[allow(unused_imports)]
    use crate::neotrix::l8_autonomic_impl::nt_mind::evolution::value_compass::ValueAction as Action;
#[allow(unused_imports)]
    use crate::neotrix::l8_autonomic_impl::nt_mind::evolution::value_learning::Outcome;
    ...
    pub fn check_goal_start(
        ...
        goal_desc: &str,
        session_id: &str,
    ) -> Result<(), crate::neotrix::l8_autonomic_impl::nt_mind::evolution::value_gate::GateResult> {
    ...
    pub fn record_goal_outcome(
        integration: &ValueIntegrationRuntime,
        goal_desc: &str,
        final_state: crate::neotrix::l8_autonomic_impl::nt_mind::evolution::goal_loop::GoalState,
        session_id: &str,
    ) {
        ...
        let outcome = crate::neotrix::l8_autonomic_impl::nt_mind::evolution::value_learning::Outcome {
            success: matches!(final_state, crate::neotrix::l8_autonomic_impl::nt_mind::evolution::goal_loop::GoalState::Achieved),
            expected: true,
            harm_occurred: false,
            trust_impact: if matches!(final_state, crate::neotrix::l8_autonomic_impl::nt_mind::evolution::goal_loop::GoalState::Achieved) { 0.3 } else { -0.3 },
...
#[allow(unused_imports)]
    use super::CompassAction;
#[allow(unused_imports)]
    use crate::neotrix::l8_autonomic_impl::nt_mind::evolution::self_evolver::SelfEvolver;
#[allow(unused_imports)]
    use crate::neotrix::l8_autonomic_impl::nt_mind::evolution::value_compass::ValueAction as Action;
#[allow(unused_imports)]
    use crate::neotrix::l8_autonomic_impl::nt_mind::evolution::value_learning::Outcome;
...
#[allow(unused_imports)]
    use super::ValueIntegrationRuntime;
#[allow(unused_imports)]
    use crate::neotrix::l8_autonomic_impl::nt_mind::reason::sleep::{SleepEngine, SleepConfig, SleepResult};
#[allow(unused_imports)]
...
#[allow(unused_imports)]
    ...
    impl ValueAwareSleepEngine {
        pub fn new(config: SleepConfig) -> Self {
            Self { inner: crate::neotrix::l8_autonomic_impl::nt_mind::reason::sleep::SleepEngine::new(config), integration: None }
        }

        pub fn with_integration(config: SleepConfig, integration: super::ValueIntegrationRuntime) -> Self {
            Self { inner: crate::neotrix::l8_autonomic_impl::nt_mind::reason::sleep::SleepEngine::new(config), integration: Some(integration) }
        }
        ...
        pub(crate) fn simulate_dream_conflicts(&self, integration: &super::ValueIntegrationRuntime) -> Result<(), String> {
            ...
            for (_name, desc) in scenarios {
                let action = crate::neotrix::l8_autonomic_impl::nt_mind::evolution::value_compass::ValueAction::new("dream", desc);
...
#[allow(unused_imports)]
    use crate::neotrix::l8_autonomic_impl::nt_mind::evolution::value_compass::ValueAction as Action;
#[allow(unused_imports)]
    use crate::neotrix::l8_autonomic_impl::nt_mind::reason::reasoning_engine::ReasoningEngine;

    /// 推理开始前快速检查（仅 Veto/Allow，不阻塞）。
    pub fn quick_check_reasoning(integration: &ValueIntegrationRuntime, query: &str) -> bool {
        let action = crate::neotrix::l8_autonomic_impl::nt_mind::evolution::value_compass::ValueAction::new("reasoning", query);
    ...
    pub fn check_reasoning_step(
        ...
        let action = crate::neotrix::l8_autonomic_impl::nt_mind::evolution::value_compass::ValueAction::new("reasoning_step", step_desc);
        let result = integration.process_action(&action, session_id);
        if result.is_blocked() {
            return Err(result);
        }
    ...
    pub fn record_reasoning_outcome(
        ...
        let action = crate::neotrix::l8_autonomic_impl::nt_mind::evolution::value_compass::ValueAction::new("reasoning_outcome", &format!("推理: {} -> {}", query, if success { "成功" } else { "失败" }));
        let outcome = crate::neotrix::l8_autonomic_impl::nt_mind::evolution::value_learning::Outcome {
            success,
            expected: true,
            harm_occurred: false,
...
#[allow(unused_imports)]
    ...
    pub fn query_memory(
        ...
        query: &str,
        limit: usize,
    ) -> Vec<crate::neotrix::l8_autonomic_impl::nt_mind::evolution::autobiographical_index::QueryResult> {
    ...
    /// 获取叙事统计。
    pub fn get_narrative_stats(integration: &ValueIntegrationRuntime) -> crate::neotrix::l8_autonomic_impl::nt_mind::evolution::narrative_self::NarrativeStats {
    ...
    ) -> Vec<crate::neotrix::l8_autonomic_impl::nt_mind::evolution::autobiographical_index::NarrativeChapter> {
...
#[allow(unused_imports)]
    ...
    pub struct ValueNarrativeAwareSleepEngine {
        inner: crate::neotrix::l8_autonomic_impl::nt_mind::reason::sleep::SleepEngine,
        pub(crate) integration: Option<super::ValueIntegrationRuntime>,
    }
    ...
    impl ValueNarrativeAwareSleepEngine {
        ...
        pub(crate) fn simulate_dream_scenarios(&self, integration: &super::ValueIntegrationRuntime) -> Result<(), String> {
            ...
            for (_name, desc) in value_scenarios {
                let action = crate::neotrix::l8_autonomic_impl::nt_mind::evolution::value_compass::ValueAction::new("dream_value", desc);
...
#[allow(unused_imports)]
    ...
    fn test_sleep_integration_dream_simulation() {
        ...
        let mut sleep = sleep_integration::ValueAwareSleepEngine::with_integration(
            crate::neotrix::l8_autonomic_impl::nt_mind::reason::sleep::SleepConfig::default(),
            rt,
        );
        // 梦境模拟不应 panic
