...
impl DaoEngine {
    ...
    fn init_rules() -> Vec<DaoRule> {
        vec![
            // ═══════ 道: 本源规则 (Layer 0) ═══════
            DaoRule {
                id: "DAO-00".into(), name: "道即本源".into(), layer: DaoLevel::Dao,
            ...
            // ═══════ 一: 统一场 (Layer 1) ═══════
            DaoRule {
                id: "DAO-01".into(), name: "信息=能量=物质 三位一体".into(), layer: DaoLevel::OneUnified,
                formulation: "E=mc² (质能等价); S=k·lnW (信息熵); 信息是物理的(Landauer原理)".into(),
                manifestation: vec!["质量与能量可转换".into(),"信息擦除需耗能(Landauer极限)".into(),
                    "宇宙总能量守恒".into(),"信息不能凭空产生或消灭".into()],
                connects_to: vec!["DAO-10".into(),"DAO-11".into(),"DAO-12".into()],
                inverse_path: vec!["计算机→晶体管→半导体→量子力学→E=mc²".into()],
            },
            // ═══════ 二: 二元性 (Layer 2) ═══════
            DaoRule {
                id: "DAO-10".into(), name: "时空二元: 存在与变化的舞台".into(), layer: DaoLevel::TwoDuality,
                formulation: "ds² = -c²dt² + dx² + dy² + dz² (闵可夫斯基时空)".into(),
                manifestation: vec!["任何事件都有时空坐标".into(),"光速是宇宙速度极限".into(),
                    "引力=时空弯曲".into(),"因果律:原因必须先于结果".into()],
                connects_to: vec!["DAO-20".into(),"DAO-21".into()],
                inverse_path: vec!["GPS→相对论修正→光速不变→闵可夫斯基时空→时空二元".into()],
            },
            DaoRule {
                id: "DAO-11".into(), name: "阴阳二元: 对立统一的普遍性".into(), layer: DaoLevel::TwoDuality,
                formulation: "∀x, ∃¬x (任何事物都有其对立面); 对立面互相依存,互相转化".into(),
                manifestation: vec!["正负电荷".into(),"物质-反物质".into(),"生-死".into(),
                    "秩序-混沌".into(),"0-1(二进制)".into(),"正-负(数学)".into()],
                connects_to: vec!["DAO-20".into(),"DAO-22".into()],
                inverse_path: vec!["计算机→二进制→阴阳→对立统一规律".into()],
            },
            DaoRule {
                id: "DAO-12".into(), name: "因果二元: 万物皆有因果".into(), layer: DaoLevel::TwoDuality,
                formulation: "P(A→B) = P(B|A)·P(A) 原因的概率决定结果的概率".into(),
                manifestation: vec!["牛顿力学(因果决定)".into(),"量子力学(概率因果)".into(),
                    "经济学(供需因果)".into(),"历史学(事件因果链)".into()],
                connects_to: vec!["DAO-20".into(),"DAO-23".into()],
                inverse_path: vec!["机器学习→统计因果→相关性→因果性→因果律".into()],
            },
            // ═══════ 三: 涌现 (Layer 3) ═══════
            DaoRule {
                id: "DAO-20".into(), name: "三生万物: 涌现的普遍机制".into(), layer: DaoLevel::ThreeEmergence,
                formulation: "当N个简单单元按规则相互作用时,出现单个单元不具备的新性质".into(),
                manifestation: vec!["水分子(H₂O)不湿,但大量水分子集体涌现出'湿性'".into(),
            ...
            // ═══════ 万物: 具体领域 (Layer 4+) ═══════
            DaoRule {
                id: "DAO-30".into(), name: "物理规则 → 宇宙万物".into(), layer: DaoLevel::TenThousand,
            ...
            DaoRule {
                id: "DAO-31".into(), name: "化学规则 → 物质万物".into(), layer: DaoLevel::TenThousand,
            ...
            DaoRule {
                id: "DAO-32".into(), name: "生命规则 → 生物万物".into(), layer: DaoLevel::TenThousand,
            ...
            DaoRule {
                id: "DAO-33".into(), name: "意识规则 → 心智万物".into(), layer: DaoLevel::TenThousand,
            ...
            DaoRule {
                id: "DAO-34".into(), name: "社会规则 → 文明万物".into(), layer: DaoLevel::TenThousand,
    ...
    fn init_domain_mappings() -> HashMap<String, Vec<String>> {
        ...
        m.insert("物理".into(), vec!["DAO-01".into(),"DAO-10".into(),"DAO-30".into()]);
        m.insert("化学".into(), vec!["DAO-01".into(),"DAO-31".into()]);
        m.insert("生物".into(), vec!["DAO-32".into(),"DAO-20".into()]);
        m.insert("计算机".into(), vec!["DAO-11".into(),"DAO-20".into(),"DAO-33".into()]);
        ...
        m.insert("哲学".into(), vec!["DAO-00".into(),"DAO-11".into(),"DAO-12".into()]);
        m
    }

    fn init_phenomena_mappings() -> HashMap<String, Vec<String>> {
        let mut m = HashMap::new();
        m.insert("智能手机".into(), vec!["DAO-01".into(),"DAO-10".into(),"DAO-30".into(),"DAO-31".into()]);
        m.insert("互联网".into(), vec!["DAO-34".into(),"DAO-11".into(),"DAO-20".into()]);
        m.insert("AI".into(), vec!["DAO-33".into(),"DAO-20".into(),"DAO-12".into()]);
        m.insert("核能".into(), vec!["DAO-01".into(),"DAO-30".into()]);
        m.insert("基因编辑".into(), vec!["DAO-32".into(),"DAO-01".into()]);
        m.insert("区块链".into(), vec!["DAO-12".into(),"DAO-34".into(),"DAO-11".into()]);
        m
    }
