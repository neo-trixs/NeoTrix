...
impl BrainStage for OracleGateStage {
    ...
    fn process(&self, brain: &mut SelfIteratingBrain) -> Result<StageDecision, NeoTrixError> {
        ...
        let gate = if let Some(ref mut g) = brain._oracle_gate {
            g
        } else {
            brain._oracle_gate = Some(OracleGate::new());
            brain._oracle_gate.as_mut().unwrap()
        };
...
impl BrainStage for SelfTestStage {
    ...
    fn process(&self, brain: &mut SelfIteratingBrain) -> Result<StageDecision, NeoTrixError> {
        ...
        registry.register(Box::new(crate::neotrix::l1_body_impl::nt_shield::guard::SecurityGuard::new()));
        registry.register(Box::new(crate::neotrix::l1_body_impl::nt_shield::permissions::PermissionManager::new()));
        registry.register(Box::new(crate::neotrix::l1_body_impl::nt_shield::safety_kernel::SafetyKernel::new()));
        registry.register(Box::new(crate::neotrix::l1_body_impl::nt_shield::policy::ActionPolicy::new()));
        registry.register(Box::new(crate::neotrix::l1_body_impl::nt_shield::perm_chain::PermissionChain::default()));
        registry.register(Box::new(crate::neotrix::l1_body_impl::nt_shield_prompt::screeners::PromptGuard::default()));
        registry.register(Box::new(crate::neotrix::l1_body_impl::nt_shield_prompt::screeners::OutputScreener::default()));
        registry.register(Box::new(crate::neotrix::l1_body_impl::nt_shield_prompt::screeners::ActionScreener::default()));
        registry.register(Box::new(crate::neotrix::l1_body_impl::nt_shield_traffic::analyzer::TrafficAnalyzer::new()));
        registry.register(Box::new(crate::neotrix::l8_autonomic_impl::nt_mind::stagnation::StagnationDetector::default()));
        registry.register(Box::new(crate::neotrix::l8_autonomic_impl::nt_mind::code_review::CodeReviewEngine::default()));
        registry.register(Box::new(crate::neotrix::l8_autonomic_impl::nt_mind::self_iterating::safety_stage::SafetyCheckStage::new()));
        registry.register(Box::new(crate::neotrix::l8_autonomic_impl::nt_mind::self_iterating::constitutional_stage::ConstitutionalSelfCritiqueStage::new()));
        registry.register(Box::new(crate::neotrix::l8_autonomic_impl::nt_mind::self_iterating::secret_scanner::SecretScanner::new()));
        registry.register(Box::new(crate::neotrix::l8_autonomic_impl::nt_mind_cleanup::CleanupEngine::new()));
        registry.register(Box::new(crate::neotrix::l8_autonomic_impl::nt_mind_ingestion::reflection_loop::QualityMonitor::new(0.5)));
        registry.register(Box::new(crate::neotrix::l8_autonomic_impl::nt_mind_ingestion::graceful_degradation::CapabilityStatus::all_available()));
