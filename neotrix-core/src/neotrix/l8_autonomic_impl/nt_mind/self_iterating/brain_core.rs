...
impl super::super::core::BrainMutView for ReasoningBrain {
    fn capability(&self) -> &super::super::core::CapabilityVector {
        &self.capability
    }
    fn capability_mut(&mut self) -> &mut super::super::core::CapabilityVector {
        &mut self.capability
    }
}
...
impl crate::core::nt_core_traits::BrainProvider for ReasoningBrain {
    ...
    fn absorb_knowledge(&mut self, source: super::super::core::KnowledgeSource) -> super::super::core::AbsorptionRecord {
        self.register_knowledge_source(source.name(), source.capability_vector().clone());
        AbsorptionRecord {
            source,
