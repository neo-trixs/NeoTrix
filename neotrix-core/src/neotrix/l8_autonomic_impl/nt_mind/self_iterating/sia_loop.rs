...
pub enum SIAImprovement {
    HarnessUpdate { new_scaffold: String, rationale: String },
    WeightUpdate { algorithm: RLAlgorithm, config: RLConfig, rationale: String },
    Converged,
}
...
impl SIAController {
    ...
    pub fn is_converged(&self) -> bool {
        self.improvements
            .last()
            .is_some_and(|i| matches!(i, SIAImprovement::Converged))
    }
