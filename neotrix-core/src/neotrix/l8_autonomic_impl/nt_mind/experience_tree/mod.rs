...
impl crate::neotrix::l8_autonomic_impl::nt_mind_hook::HookAction for SessionEndHook {
    fn name(&self) -> &str {
        "experience_session_end_hook"
    }

    fn execute(&self, ctx: &crate::neotrix::l8_autonomic_impl::nt_mind_hook::HookContext) -> crate::neotrix::l8_autonomic_impl::nt_mind_hook::HookResult {
        ...
        crate::neotrix::l8_autonomic_impl::nt_mind_hook::HookResult::ok(&format!(
