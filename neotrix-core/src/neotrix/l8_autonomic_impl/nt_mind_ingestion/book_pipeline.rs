use super::{IngestionPipeline, IngestionConfig, IngestionResult, SourceType, ReflectionRound};
use super::reflection_loop::{ReflectionLoop, QualityMonitor};
...
impl BookPipeline {
    ...
    fn align_ontology(&self, entities: &[String], _relations: &[(String, String, String)]) -> Vec<String> {
    ...
    fn reason(&self, entities: &[String], relations: &[(String, String, String)], round: usize) -> Vec<String> {
    ...
    fn simulate_llm_round(&self, input: &str, round: usize) -> (Vec<String>, Vec<String>, Vec<(String, String, String)>, Vec<String>) {
...
impl IngestionPipeline for BookPipeline {
    ...
    fn process(&self, input: &str, config: &IngestionConfig) -> IngestionResult {
        ...
        let _last_round = reflection.rounds.last().cloned().unwrap_or(ReflectionRound {
            round: 0,
            insights: vec![],
            clarity_delta: 0.0,
            converged: false,
        ...
        IngestionResult {
            ...
            summary: format!("{} | steps: {} | {}", summary, self.steps.len(), self.apply(&self.generate_skus(&reasoning))),
