...
impl SkillQualityScorer {
    ...
    pub fn evaluate(skill: &SkillEntry) -> SkillQualityScores {
        ...
        let resident_tokens =
            crate::neotrix::l3_memory_impl::nt_memory_kb::nt_memory_skill_cost::estimate_tokens(&skill.content);
        let body_tokens =
            crate::neotrix::l3_memory_impl::nt_memory_kb::nt_memory_skill_cost::estimate_tokens(body);
        let desc_tokens =
            crate::neotrix::l3_memory_impl::nt_memory_kb::nt_memory_skill_cost::estimate_tokens(&skill.description);
...
impl SkillEngine {
    ...
    pub fn audit_residency(&self) -> Vec<ResidencyAuditRow> {
        crate::neotrix::l8_autonomic_impl::nt_mind_skill_engine::audit_residency(&self.quality_stats)
    }
