...
impl SkillMemory {
    ...
    /// 同步到 KB experience 命名空间
    pub async fn sync_to_kb(&self, kb: &Arc<crate::neotrix::l3_memory_impl::nt_memory_kb::KnowledgeBase>) -> Result<usize, String> {
        let mut synced = 0;
...
pub struct ExperienceMemoryManager {
    ...
    kb: Option<Arc<crate::neotrix::l3_memory_impl::nt_memory_kb::KnowledgeBase>>,
}
...
impl ExperienceMemoryManager {
    ...
    pub fn with_kb(mut self, kb: Arc<crate::neotrix::l3_memory_impl::nt_memory_kb::KnowledgeBase>) -> Self {
        self.kb = Some(kb);
        self
    }
