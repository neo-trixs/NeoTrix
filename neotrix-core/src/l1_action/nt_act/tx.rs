    ...
    let recid = [0u8, 1u8]
        ...
        .find(|&rid| {
            ...
            VerifyingKey::recover_from_prehash(hash.as_slice(), sig, rec_id)
                .is_ok_and(|recovered| recovered == *vk)
        })
        .unwrap_or(0);
...
mod tests {
    use super::*;
    use crate::l1_action::nt_act_crypto::wallet::CryptoWallet;
    use crate::l1_action::nt_act_crypto::chain::ChainType;
