...
use crate::l1_action::nt_act_code::code_writer::{CodeGenRequest, SelfCodeWriter};
use crate::l1_action::nt_act_code::edit_history::EditHistoryTracker;
use crate::l1_action::nt_act_code::safe_applier::SafeCodeApplier;
...
impl PipelineAutoFixer {
    ...
    pub fn run_pipeline(&mut self, el: &mut dyn EvolutionLoopProvider) -> PipelineResult {
        // 1. 诊断
...
//     use crate::l1_action::nt_act::nt_l1_shared_types::PrioritizedIssue;
    ...
    #[test]
    fn test_run_pipeline_empty_mock() {
        let mut el = MockEvolutionLoop { call_count: 0 };
        let tmp = std::env::temp_dir().join(format!("paf_mock_test_{}", std::process::id()));
