use crate::l1_action::nt_act_autonomy::awareness_monitor::{AwarenessReport, GapSeverity};
...
impl crate::core::nt_core_self_test::SelfTest for OracleGate {
    ...
    fn self_test(&self) -> Result<(), Vec<String>> {
        ...
        let report = crate::l1_action::nt_act_autonomy::awareness_monitor::AwarenessReport {
            gaps: vec![],
            total_gap: 0.0,
            critical_count: 0,
            significant_count: 0,
...
mod tests {
    use super::*;
    use crate::l1_action::nt_act_autonomy::awareness_monitor::{AwarenessReport, CapabilityGap, GapSeverity};
