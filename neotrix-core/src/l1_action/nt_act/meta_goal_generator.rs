use crate::l1_action::nt_act_autonomy::trend_analyzer::{TrendDirection, TrendReport};
use crate::l1_action::nt_act_goal::goal_generator::{EvolutionGoal, GoalCategory, GoalPriority};
    ...
    pub fn generate_from_trends(&self, report: &TrendReport) -> Vec<MetaGoal> {
        ...
        if report.overall_direction == TrendDirection::Declining {
            goals.push(MetaGoal {
                ...
                description: "Overall evolution quality is declining — tighten quality gates".into(),
        ...
        if report.improving_count == 0 && !report.trends.is_empty() {
            goals.push(MetaGoal {
                ...
                description: "No improving trends detected — expand knowledge domains to unlock improvements".into(),
...
mod tests {
    use super::*;
    use crate::l1_action::nt_act_autonomy::trend_analyzer::Trend;
    ...
    fn test_generate_from_declining_trends() {
        ...
        assert!(goals.iter().any(|g| g.category == MetaGoalCategory::ProcessImprovement));
    }
