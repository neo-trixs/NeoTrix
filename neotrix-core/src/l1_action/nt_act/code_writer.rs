...
//                 issue_type: crate::l1_action::nt_act::nt_l1_shared_types::IssueType::TodoLeftovers,
    ...
    fn test_generate_with_pairwise_entropy_low_threshold_defers() {
        let detector = crate::l1_action::nt_act_code::semantic_entropy::SemanticEntropy::new(3, 0.01);
    ...
    fn test_with_entropy_detector_some() {
        let detector = crate::l1_action::nt_act_code::semantic_entropy::SemanticEntropy::default();
