...
pub struct AppState {
    ...
    pub digital_human: Arc<Mutex<crate::l1_action::nt_io::nt_io_digital_human::DigitalHumanPipeline>>,
    /// LLM 网关实例 — 由 server 启动时创建并存入 state, api 路由复用 (R-P36)。
    pub gateway: Option<Arc<crate::l1_action::nt_io::nt_io_provider::gateway::GatewayV2>>,
}
