...
//!
//! 复用 [`crate::l1_action::nt_memory::nt_memory_kb::nt_memory_geo::query_bbox_with_cold`]
...
pub async fn geo_tiles_handler(
    ...
    let result = tokio::task::spawn_blocking(move || {
        ...
        let (records, cold_hits) = crate::l1_action::nt_memory::nt_memory_kb::nt_memory_geo::query_bbox_with_cold(
            &conn,
            s,
            w,
            n,
