...
mod tests {
    ...
    fn test_search_with_confidence_filters_by_conservative() {
        ...
        let kb = crate::l1_action::nt_memory::nt_memory_kb::KnowledgeBase {
            ...
            adaptive: crate::l1_action::nt_memory::nt_memory_kb::nt_memory_adaptive_rag::AdaptiveRetrieval::new(
                crate::l1_action::nt_memory::nt_memory_kb::nt_memory_adaptive_rag::AdaptiveRagConfig::default(),
            ),
            commitment_store: std::sync::RwLock::new(
                crate::l1_action::nt_memory::nt_memory_kb::nt_memory_commitment::EmbeddingCommitmentStore::new(0, None),
            ),
            confidence_store: std::sync::RwLock::new(
                crate::l1_action::nt_memory::nt_memory_kb::nt_memory_confidence::ConfidenceStore::new(
                    crate::l1_action::nt_memory::nt_memory_kb::nt_memory_confidence::DecayConfig::default(),
                ),
            ),
            community_search: std::sync::RwLock::new(
                crate::l1_action::nt_memory::nt_memory_kb::nt_memory_community::CommunityAwareSearch::new(
                    crate::l1_action::nt_memory::nt_memory_kb::nt_memory_community::CommunityDetector::default(),
                ),
            ),
            privacy: std::sync::RwLock::new(
                crate::l1_action::nt_memory::nt_memory_kb::privacy::PrivacyEnforcer::new(
                    crate::l1_action::nt_memory::nt_memory_kb::privacy::PrivacyConfig::default(),
                ),
            ),
            vector_adapter: std::sync::RwLock::new(None),
            agent_memory: std::sync::RwLock::new(
                crate::l1_action::nt_memory::nt_memory_kb::nt_memory_agent_driven::AgentMemory::new(
                    crate::l1_action::nt_memory::nt_memory_kb::nt_memory_agent_driven::MemoryConfig::default(),
                ),
            ),
            ...
            proficiency: std::sync::RwLock::new(
                crate::l1_action::nt_memory::nt_memory_kb::nt_memory_proficiency::MemoryProficiency::new(),
            ),
            graphrag_store: std::sync::RwLock::new(None),
            tech_reserve: std::sync::RwLock::new(
                crate::l1_action::nt_memory::nt_memory_kb::nt_memory_tech_reserve::TechReserveStore::new(),
            ),
            graph_cache: std::sync::RwLock::new(
                crate::l1_action::nt_memory::nt_memory_kb::nt_memory_graph_cache::GraphCache::new(
                    &rusqlite::Connection::open_in_memory().unwrap()
                ).unwrap_or_else(|_| crate::l1_action::nt_memory::nt_memory_kb::nt_memory_graph_cache::GraphCache::empty()),
            ),
            skills_library: std::sync::RwLock::new(
                crate::l1_action::nt_memory::nt_memory_kb::nt_memory_knowledge_assets::SkillsLibrary::new(),
            ),
            feedback_store: std::sync::RwLock::new(
                crate::l1_action::nt_memory::nt_memory_kb::nt_memory_feedback::FeedbackStore::new(0.1),
            ),
            gwt_router: std::sync::RwLock::new(
                crate::l1_action::nt_memory::nt_memory_kb::nt_memory_gwt_router::GwtRouter::new(
                    crate::l1_action::nt_memory::nt_memory_kb::nt_memory_gwt_router::GwtRouterConfig::default(),
                ),
            ),
            vsa_expander: std::sync::RwLock::new(
                crate::l1_action::nt_memory::nt_memory_kb::nt_memory_vsa_expand::VsaAssociativeExpander::default(),
            ),
            retrieval_evolver: std::sync::RwLock::new(
                crate::l1_action::nt_memory::nt_memory_kb::nt_memory_search::RetrievalEvolver::new(),
            ),
            temporal_ledger: std::sync::Mutex::new(
                crate::l1_action::nt_memory::nt_memory_historian::TemporalFactLedger::open(
