...
pub fn export_geo_ntpack(
    ...
    use crate::l1_action::nt_memory::nt_memory_kb::nt_memory_pack::{GeoPoint, PackEncoder};
...
mod tests {
    ...
    fn test_import_batch_commit_large() {
        ...
        let mut pts = Vec::new();
        for i in 0..1200 {
            pts.push(crate::l1_action::nt_memory::nt_memory_kb::nt_memory_pack::GeoPoint {
        ...
        let enc = crate::l1_action::nt_memory::nt_memory_kb::nt_memory_pack::PackEncoder::new(5, true);
        let bytes = enc.encode(&pts);
    ...
    fn test_append_merge_semantics() {
        // A4: 追加模式 — 新覆盖旧, 文件可重读
        use crate::l1_action::nt_memory::nt_memory_kb::nt_memory_pack::GeoPoint;
