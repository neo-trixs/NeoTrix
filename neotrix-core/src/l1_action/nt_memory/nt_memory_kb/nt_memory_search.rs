...
mod precision_gate_tests {
    use super::*;
    use crate::l1_action::nt_memory::nt_memory_kb::nt_memory_types::KnowledgeNode;

    fn node(id: &str) -> KnowledgeNode {
        KnowledgeNode {
            id: id.into(),
            node_type: crate::l1_action::nt_memory::nt_memory_kb::nt_memory_types::NodeType::Concept,
            title: id.into(),
            summary: None,
            content: None,
            url: None,
