...
pub struct NucleiCheckRegistry {
    pub index: Arc<NucleiTemplateIndex>,
    pub check_registry: Arc<crate::l3_embodiment::nt_shield::check_registry::CheckRegistry>,
}

impl NucleiCheckRegistry {
    pub fn new(index: Arc<NucleiTemplateIndex>, check_registry: Arc<crate::l3_embodiment::nt_shield::check_registry::CheckRegistry>) -> Self {
