...
pub struct StealthHttpClient {
    ...
    pub(super) comm_persona: RwLock<Option<crate::l3_embodiment::nt_shield::nt_shield_comm::Persona>>,
}
...
impl StealthHttpClient {
    ...
    pub async fn enable_persona(&self, persona_key: &str) {
        use crate::l3_embodiment::nt_shield::nt_shield_comm::{persona_by_key, select_persona_weighted};
