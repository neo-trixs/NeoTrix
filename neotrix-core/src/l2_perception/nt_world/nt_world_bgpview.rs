...
pub fn bgpview_egress_rule() -> crate::l1_action::nt_io::nt_shield_sandbox::EgressRule {
    crate::l1_action::nt_io::nt_shield_sandbox::EgressRule::allow(BGPVIEW_HOST, "443")
}
pub fn bgpview_egress_policy() -> crate::l1_action::nt_io::nt_shield_sandbox::EgressPolicy {
    crate::l1_action::nt_io::nt_shield_sandbox::EgressPolicy::new(vec![bgpview_egress_rule()], false)
}
