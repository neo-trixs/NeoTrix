...
pub fn ofac_egress_rule() -> crate::l1_action::nt_io::nt_shield_sandbox::EgressRule {
    crate::l1_action::nt_io::nt_shield_sandbox::EgressRule::allow(OFAC_HOST, "443")
}
pub fn ofac_egress_policy() -> crate::l1_action::nt_io::nt_shield_sandbox::EgressPolicy {
    crate::l1_action::nt_io::nt_shield_sandbox::EgressPolicy::new(vec![ofac_egress_rule()], false)
}
