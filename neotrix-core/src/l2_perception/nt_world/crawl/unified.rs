...
impl UnifiedCrawler {
    ...
    pub fn run_cycle(&mut self, cap: &mut CapabilityVector, bank: &mut ReasoningBank) -> CycleResult {
        ...
        let ret = 'cycle: {
            ...
            let text = {
                use crate::l2_perception::nt_world::nt_world_doc;
            ...
            if let Some(body) = &result.body {
                ...
                if let Some(pf) = &self.prefetch {
                    use crate::l2_perception::nt_world::nt_world_prefetch::PrefetchedUrl;
    ...
    fn analyze_gaps(&self) -> Vec<GapReport> {
        let mut reports = Vec::new();
        for dim in 0..8 {
            let current = self.cube.coord_density(dim);
...
mod tests {
    ...
    fn test_attach_prefetch_wiring() {
        ...
        let pf = crate::l2_perception::nt_world::nt_world_prefetch::TwoPhaseCrawler::new(
    ...
    fn test_prefetch_filter_reduces_links() {
        use crate::l2_perception::nt_world::nt_world_prefetch::{PrefetchedUrl, TwoPhaseCrawler};
