...
impl CliCommand for AbsorbCommand {
    ...
    fn description(&self) -> &str {
        "Absorb knowledge from a source: /absorb source=HeroUI"
    }
    fn execute(
        &self,
        args: &[String],
...
impl CliCommand for EvolveCommand {
    ...
    fn description(&self) -> &str {
        "Evolve from a URL: /evolve url=https://github.com/..."
    }
    fn execute(
        &self,
        args: &[String],
...
impl CliCommand for MemCommand {
    ...
    fn description(&self) -> &str {
        "Search memory via ReasoningBank: /mem query=design patterns"
    }
    fn execute(
        &self,
        args: &[String],
...
impl CliCommand for SessionCommand {
    ...
    fn description(&self) -> &str {
        "Session management: /session list | switch <id> | new [name] | delete <id>"
    }
    fn execute(
        &self,
        args: &[String],
        ...
        match sub {
            "list" | "ls" => CommandOutput::ok("Sessions:\n  s-1  (active)  default"),
            "switch" | "sw" => {
            ...
            _ => CommandOutput::err(&format!(
                "Unknown subcommand: {}. Use: list, switch, new, delete",
                sub
            )),
        }
    }
...
impl CliCommand for ConfigCommand {
    ...
    fn description(&self) -> &str {
        "Set config values: /config key=value or /config list"
    }
    fn execute(
        &self,
        args: &[String],
...
impl CliCommand for AgentCommand {
    ...
    fn description(&self) -> &str {
        "Agent management: /agent create <role> | list | status <id>"
    }
    fn execute(
        &self,
        args: &[String],
        ...
        match sub {
            ...
            _ => CommandOutput::err(&format!(
                "Unknown subcommand: {}. Use: create, list, status, kill",
                sub
            )),
        }
    }
