...
impl CliCommand for ReviewCmd {
    ...
    fn aliases(&self) -> Vec<&str> { vec!["/r", "/code-review", "review"] }
    fn description(&self) -> &str { "Code review: staged|unstaged|file <path>|all [--nt_shield] [--full]" }
    fn execute(&self, args: &[String], _brain: Option<&Arc<RwLock<SelfIteratingBrain>>>) -> CommandOutput {
        ...
        match subcmd {
            ...
            "help" => CommandOutput::ok("Usage: /review staged|unstaged|file <path>|all [--nt_shield] [--full]"),
            _ => CommandOutput::err("Usage: /review staged|unstaged|file <path>|all [--nt_shield] [--full]"),
        }
    }
}
...
impl ReviewCmd {
    ...
    fn analyze_content(&self, content: &str, label: &str) -> String {
        ...
        let nt_shield_patterns: &[(&str, &str)] = &[
            ...
            (r"\bunsafe\b", "Usage of `unsafe` block \u{2014} verify safety invariants"),
