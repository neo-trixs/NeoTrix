...
mod tests {
    ...
    fn test_global_state_integration() {
        ...
        let _ = crate::cli::approval::global_approval().lock().unwrap().set_mode(crate::cli::approval::ApprovalMode::Suggest);
        ...
        reset_profile_manager();
        crate::cli::approval::global_approval().lock().unwrap().set_mode(crate::cli::approval::ApprovalMode::Suggest);
        assert!(switch_profile("developer").is_ok());
        {
            let engine = crate::cli::approval::global_approval().lock().unwrap();
            assert_eq!(engine.mode(), crate::cli::approval::ApprovalMode::AutoEdit,
