...
use crate::l5_cognition::nt_mind::nt_mind::evolution::autobiographical_index::{AutobiographicalIndex, AutobiographicalEntry, NarrativeChapter, NarrativeArcType, IndexConfig};
...
impl NarrativeIntegrator {
    ...
    fn build_chapter_from_cluster(&self, conn: &Connection, cluster: &ThemeCluster) -> Result<Option<IntegrationResult>, String> {
        ...
        // 持久化章节
        crate::l5_cognition::nt_mind::nt_mind::evolution::autobiographical_index::AutobiographicalIndex::persist_chapter(conn, &chapter)?;
...
mod tests {
    ...
    fn test_narrative_integration_basic() {
        ...
        // 添加一组相关记忆
        for i in 0..8 {
            let entry = crate::l5_cognition::nt_mind::nt_mind::evolution::autobiographical_index::AutobiographicalEntry {
                id: format!("e{}", i),
