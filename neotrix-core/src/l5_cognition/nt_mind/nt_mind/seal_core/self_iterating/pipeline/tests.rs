...
fn constant_rewards_yield_zero_divergence() {
    ...
    let r = crate::l5_cognition::nt_mind::crate::l5_cognition::nt_mind::nt_mind::crate::l5_cognition::nt_mind::nt_mind::crate::l5_cognition::nt_mind::nt_mind::seal_core::self_iterating::pipeline::compute_credit_divergence(&rewards, 0.95);
...
fn step_credit_audit_stage_runs_and_persists() {
    ...
    let stage = crate::l5_cognition::nt_mind::crate::l5_cognition::nt_mind::nt_mind::crate::l5_cognition::nt_mind::nt_mind::crate::l5_cognition::nt_mind::nt_mind::seal_core::self_iterating::pipeline::StepCreditAuditStage::new();
    assert_eq!(stage.name(), "step_credit_audit");
    let out = stage.process(&mut brain).expect("stage runs");
    assert!(matches!(out, crate::l5_cognition::nt_mind::crate::l5_cognition::nt_mind::nt_mind::crate::l5_cognition::nt_mind::nt_mind::crate::l5_cognition::nt_mind::nt_mind::seal_core::self_iterating::pipeline::StageDecision::Continue));
}
