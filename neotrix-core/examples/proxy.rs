...
//! 使用方式: cargo run --example proxy --features stealth-net
...
fn main() {
    println!("This example requires the 'stealth-net' feature.");
    println!("Run: cargo run --example proxy --features stealth-net");
}
